...
public class HistoricalDataApp extends Application {

	private ConfigurableApplicationContext springContext;

	private static final Logger log = LoggerFactory.getLogger(HistoricalDataApp.class);
	...
	public static void main(final String[] args) throws Exception {
		launch(HistoricalDataApp.class, args);
	}

	@Override
	public void init() throws Exception {
		springContext = SpringApplication.run(HistoricalDataApp.class);
		HistoricalDataController c = (HistoricalDataController) springContext.getBean(HistoricalDataController.class);
